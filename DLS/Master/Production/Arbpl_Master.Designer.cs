namespace DLS.Master.Production
{
    partial class Arbpl_Master
    {
        ...
        {
            this.gc_Arbpl_list = new DevExpress.XtraGrid.GridControl();
            this.gv_Arbpl_list = new DevExpress.XtraGrid.Views.Grid.GridView();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.gc_Arbpl_list)).BeginInit();
            ((System.ComponentModel.ISupportInitialize)(this.gv_Arbpl_list)).BeginInit();
            ...
            // gc_Arbpl_list
            // 
            this.gc_Arbpl_list.Dock = System.Windows.Forms.DockStyle.Fill;
            this.gc_Arbpl_list.Location = new System.Drawing.Point(0, 83);
            this.gc_Arbpl_list.MainView = this.gv_Arbpl_list;
            this.gc_Arbpl_list.Name = "gc_Arbpl_list";
            this.gc_Arbpl_list.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] {
            this.repositoryItemHyperLinkEdit_Delete,
            this.repositoryItemHyperLinkEdit_Save});
            this.gc_Arbpl_list.Size = new System.Drawing.Size(1357, 645);
            this.gc_Arbpl_list.TabIndex = 20;
            this.gc_Arbpl_list.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {
            this.gv_Arbpl_list});
            // 
            // gv_Arbpl_list
            // 
            this.gv_Arbpl_list.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {
            this.Code,
            this.Textgv,
            this.Save,
            this.Delete});
            this.gv_Arbpl_list.GridControl = this.gc_Arbpl_list;
            this.gv_Arbpl_list.Name = "gv_Arbpl_list";
            this.gv_Arbpl_list.OptionsView.NewItemRowPosition = DevExpress.XtraGrid.Views.Grid.NewItemRowPosition.Top;
            this.gv_Arbpl_list.RowUpdated += new DevExpress.XtraGrid.Views.Base.RowObjectEventHandler(this.gv_Arbpl_list_RowUpdated);
            this.gv_Arbpl_list.ValidatingEditor += new DevExpress.XtraEditors.Controls.BaseContainerValidateEditorEventHandler(this.gv_Arbpl_list_ValidatingEditor);
            // 
            // Code
            // 
            this.Code.Caption = "작업장 코드";
            ...
            this.Controls.Add(this.gc_Arbpl_list);
            this.Controls.Add(this.pc_main);
            this.Name = "Arbpl_Master";
            this.Text = "작업장마스터";
            this.Load += new System.EventHandler(this.Arbpl_Master_Load);
            ((System.ComponentModel.ISupportInitialize)(this.gc_Arbpl_list)).EndInit();
            ((System.ComponentModel.ISupportInitialize)(this.gv_Arbpl_list)).EndInit();
        ...
        private DevExpress.XtraGrid.GridControl gc_Arbpl_list;
        private DevExpress.XtraGrid.Views.Grid.GridView gv_Arbpl_list;
